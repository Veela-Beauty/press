...
def callback(code=None, state=None):
	...
	if (state == cached_state) or (saas_app):
		...
		return "Invalid state parameter. The session timed out. Please try again or contact  Accurate Systems Cloud support at https://accuratesystems.com.sa/support"
