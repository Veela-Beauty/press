...
DOC_URLS = {
	JobErr.OOM: "https://accuratesystems.com.sa/docs/common-issues/oom-issues",
	JobErr.ROW_SIZE_TOO_LARGE: "https://accuratesystems.com.sa/docs/faq/site#row-size-too-large-error-on-migrate",
	JobErr.DATA_TRUNCATED_FOR_COLUMN: "https://accuratesystems.com.sa/docs/faq/site#data-truncated-for-column",
	JobErr.BROKEN_PIPE_ERR: None,
	JobErr.CANT_CONNECT_TO_MYSQL: "https://accuratesystems.com.sa/docs/cant-connect-to-mysql-server",
	JobErr.LOST_CONN_TO_MYSQL: "https://accuratesystems.com.sa/docs/site/common-issues/lost-connection-to-mysql-server",
	JobErr.GZIP_TAR_ERR: "https://accuratesystems.com.sa/docs/sites/migrate-an-existing-site#tar-gzip-command-fails-with-unexpected-eof",
	JobErr.UNKNOWN_COMMAND_HYPHEN: "https://accuratesystems.com.sa/docs/unknown-command-",
	JobErr.RQ_JOBS_IN_QUEUE: "https://accuratesystems.com.sa/docs/faq/site#how-do-i-deactivate-my-site-",
}
