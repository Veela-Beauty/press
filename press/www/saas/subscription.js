...
function get_subscription_url() {
	if (
		...
		return `https://accuratesystems.com.sa/dashboard/app-trial/setup/${frappe.boot.subscription_conf.app_trial}#subscription`;
	}
	let sitename = frappe.boot.sitename;
	return `https://accuratesystems.com.sa/dashboard/sites/${sitename}`;
}
