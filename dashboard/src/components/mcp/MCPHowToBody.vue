<template>
	<div class="space-y-3 px-4 py-4 text-sm text-gray-700">
		<p class="text-xs leading-relaxed text-gray-600">
			...
			Each agent gets a scoped token; calls are audit-logged in the Recent Calls tab.
		</p>
		<div>
		...
		<div>
			...
			<ul class="mt-0.5 list-disc space-y-1 pl-5 text-xs leading-relaxed">
				...
				<li>The <strong>Recent Calls</strong> tab shows every API call (paginated). Status, duration, error — full audit trail.</li>
			</ul>
		</div>
