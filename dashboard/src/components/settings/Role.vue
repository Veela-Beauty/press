<template>
	...
	<RolePermissions
		...
		:allow_invite_team_members="role.doc?.allow_invite_team_members"
		:allow_manage_team_members="role.doc?.allow_manage_team_members"
		:allow_manage_team_roles="role.doc?.allow_manage_team_roles"
