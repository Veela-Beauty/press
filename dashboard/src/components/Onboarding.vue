<template>
	<div class="mx-auto max-w-2xl rounded-lg border-0 px-2 sm:border sm:p-8">
		<div class="prose prose-sm max-w-none">
			<!-- Rebrand: Accurate Systems Cloud -->
		<h1 class="text-2xl font-semibold">Welcome to Accurate Systems Cloud</h1>
			<p>
				Accurate Systems Cloud makes it easy to manage sites and apps like ERPNext in an
			...
			<div v-if="pendingSiteRequest">
				...
				<div class="mt-2 pl-7" v-if="pendingSiteRequest.status == 'Error'">
					<p class="mt-2 text-p-base text-gray-800">
						Please contact Accurate Systems Cloud support by clicking on the button below.
					</p>
