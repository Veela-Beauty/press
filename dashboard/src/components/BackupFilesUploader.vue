	...
	methods: {
		...
		async backupFileChecker(file, type) {
			...
			if (file.size > 5 * 1024 * 1024 * 1024) {
				throw new Error(
					'File size exceeds the limit of 5 GiB. Please try the <a href="https://accuratesystems.com.sa/docs/sites/migrate-an-existing-site#migrate-using-python-script" class=underline>migrate</a> script.',
				);
			}
