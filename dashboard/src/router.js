...
let router = createRouter({
	...
	routes: [
		...
		},
		{
			...
			name: 'Daman Backup Jobs',
			component: () => import('./pages/backups/ServerBackups.vue'),
			props: true,
		},
		{
			path: '/backups/jobs',
			name: 'Daman Job Queue',
			component: () => import('./pages/backups/BackupJobs.vue'),
			props: true,
		},
		{
			path: '/backups/backup-servers',
			name: 'Daman Backup Servers',
			component: () => import('./pages/backups/BackupServers.vue'),
			props: true,
		},
		{
		...
		},
		{
			...
			name: 'Daman Restore Tests',
			component: () => import('./pages/backups/RestoreTests.vue'),
			props: true,
		},
		{
			path: '/backups/alerts',
